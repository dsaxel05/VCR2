...
**An evidence-first diligence engine for venture investors.** VCR2 rebuilds a startup's revenue from its own customer ledger, recomputes every headline metric from primitives, shows exactly where the stated figures disagree with the arithmetic, stress-tests the runway, prices the deal, and turns every gap into the question to ask on the next call.
...
<p align="center">
  <img src="docs/demo.gif" alt="VCR2 walkthrough: loading a data pack, verification, and the report tabs" width="820">
</p>
...
|---|---|
| ![Overview](docs/screenshot-overview.png) | ![Revenue](docs/screenshot-revenue.png) |
| **Runway odds (Monte Carlo)** | **Deal maths and liquidation waterfall** |
| ![Runway](docs/screenshot-runway.png) | ![Deal](docs/screenshot-deal.png) |
| **Verification before any score** | **A clean data pack earns a score** |
| ![Verification](docs/screenshot-verification.png) | ![Scored](docs/screenshot-scored.png) |
| **Risk map by type** | **VC Method and First Chicago returns** |
| ![Risk map](docs/screenshot-riskmap.png) | ![Returns](docs/screenshot-returns.png) |

<p align="center"><b>Owner Studio — start from what an investor told you</b><br><img src="docs/screenshot-studio-start.png" alt="VCR2 Owner Studio start page: every kind of change, grouped" width="900"></p>

<p align="center"><b>Owner Studio — add metrics, questions and checks without code</b><br><img src="docs/screenshot-studio.png" alt="VCR2 Owner Studio: custom metrics with formulas" width="900"></p>
...
Sample files to try the uploads are in [`examples/`](examples/) — a customer ledger (CSV and Excel), monthly financials and a comparables template.
...
**Run the tests:** `node tests/engine.test.mjs`
